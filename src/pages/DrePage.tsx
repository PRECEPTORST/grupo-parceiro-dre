...
function QuadroDespesas({ dre, temOrcamento }: { dre: ReturnType<typeof montarDre>; temOrcamento: boolean }) {
  ...
  const totalOrc = orc('despesas_administrativas') + orc('despesas_comerciais') + orc('despesa_financeira') - orc('receita_financeira') + orc('impostos_lucro')
  return (
