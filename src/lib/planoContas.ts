...
export const PLANO_CONTAS: PlanoConta[] = [
  ...
  // Aqui existiu uma 4.1.19, "Variação de estoque (apropriação)", que eu criei.
  // O plano de contas do cliente vai de 4.1.01 a 4.1.17 e não tem conta de
  // variação de estoque; inventar linha no plano de contas de um cliente não é
  // decisão de quem escreve o código. A apropriação passou a entrar na conta de
  // aquisição do próprio grão (4.1.01/02/03/05) — ver `custoMedio.ts`.
